...
Requires
Python ≥ 3.8 -> tested with 11.4.1
PyTorch ≥ 1.12
A CUDA-compatible GPU if you're training on GPU


https://huggingface.co/docs/diffusers/v0.17.1/en/training/instructpix2pix

Install diffusers with `pip install git+https://github.com/huggingface/diffusers`.
